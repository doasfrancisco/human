...
4. If you make any changes to the CLI dmap.py file, decompile/skill/decompile-claude/SKILL.md or decompile/projects/web.html. Promote it and copy it to the version found at projects/decompiler/dmap.py, projects/decompiler/SKILL.md, projects/decompiler/web.html