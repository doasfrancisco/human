...
3. If you make any changes to decompile/skill/decompile/SKILL.md redeploy using decompile/deploy.py
4. If you make any changes to the CLI decompiler.py or cmd_map.py files, decompile/skill/decompile/SKILL.md or decompile/projects/web.html. Promote it and copy it to the version found at projects/decompiler/decompiler.py, projects/decompiler/cmd_map.py, projects/decompiler/SKILL.md, projects/decompiler/web.html