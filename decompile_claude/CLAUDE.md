...
3. If you make any changes to decompile_claude/skill/decompile-claude/SKILL.md redeploy using decompile_claude/deploy.py
4. If you make any changes to the CLI dmap.py file, decompile_claude/skill/decompile-claude/SKILL.md or decompile_claude/projects/web.html. Promote it and copy it to the version found at projects/decompiler/dmap.py, projects/decompiler/SKILL.md, projects/decompiler/web.html