...
3. If you make any changes to the CLI dmap.py file, decompile_claude/skill/decompile-claude/SKILL.md or decompile_claude/projects/web.html. Promote it and copy it to the version found at projects/dmap.py , projects/SKILL.md, projects/web.html